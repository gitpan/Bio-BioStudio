#
# BioStudio Chromosome Segmenter GBrowse interface
#

=head1 NAME

Bio::Graphics::Browser2::Plugin::BS_ChromosomeSegmenter
...
package Bio::Graphics::Browser2::Plugin::BS_ChromosomeSegmenter;
...
##Global variables
my $BS;
my $plugin_name = 'BS_ChromosomeSegmenter';
...
sub name
{
  return "BioStudio: Segment the Chromosome";
}
...
sub description
{
  return p("This plugin will segment a chromosome into modular, assemblable
  pieces by the placement of restriction enzyme recognition sites. You must run
  Chromosome Segmentation Planner first.");
}
